...
namespace api.Database{
    public class WriteCustomer : IWriteCustomer
    {
        public void Write(Customer i){
            ...
            // cmd.CommandText = @"INSERT into account (Email,Password,AcctType) VALUES (@email,@password,'customer');
            //                 INSERT into customer (fname, lname, DOB, gender, acctID, phone) VALUES (@fname,@lname,@dob,@gender, (SELECT acctID FROM Account WHERE acctID=@email), @phone)";
